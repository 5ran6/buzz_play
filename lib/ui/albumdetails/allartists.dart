...
class AllArtistList extends StatefulWidget {
  @override
  _AllArtistListState createState() => _AllArtistListState();
}

AppConfig _appConfig;

class _AllArtistListState extends State<AllArtistList> {
  var value;
  ...
  void getpopuleralbumlist() async {
    await networkUtil.getall_artist(NetworkUtil.userid).then((value) {});
