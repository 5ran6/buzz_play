...
import 'package:buzz_play/ui/signup/SignUp.dart';
...
// this line do auth in firebase with your facebook credential.
  ...
  void submit() async {
    Dialogs.showLoadingDialog(context, _keyLoader); //in
    // v
    ...
    await networkUtil
        .signin(emailController.text, passController.text, token)
        .then((value) {
    ...
    if (NetworkUtil.rregisters == null) {
